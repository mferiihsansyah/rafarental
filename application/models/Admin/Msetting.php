...
class Msetting extends CI_Model {
	...
	/*
	   Fungsi Account Setting
	*/
	public function load_set_account()
	{
		$this->db->select('*');
	...
	*/
	...
	function show_user(){
            ...
            $hasil=$this->db->query("SELECT * FROM bb_admin");
	...
	*/
	...
	// load data page bank
 	public function load_data_page_user($order, $offset, $limit, $search)
 	{
