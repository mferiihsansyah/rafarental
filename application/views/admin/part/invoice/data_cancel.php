    ...
    <div class="col-xs-12 col-md-12">
        <div class="widget">
            <div class="widget-header ">
                <span class="widget-caption">Tagihan Dibatalkan</span>
            </div>
                ...
                <table class="table table-striped table-hover table-bordered" id="simpledatatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo base_url();?>admin/invoice/invoice_delete/<?php echo $tampil->id_inv;?>" class="btn btn-danger btn-xs delete"><i class="fa fa-trash-o"></i> Hapus</a>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
