<section class="banner-bottom-wthreelayouts py-lg-5 py-3">
	<div class="container-fluid">
		<div class="inner-sec-shop px-lg-4 px-3">
			<h3 class="tittle-w3layouts my-lg-4 mt-3">List Mobil <?php echo $mirip?></h3>
			<div class="row">
				<!-- product left -->
				...
				<div class="left-ads-display col-lg-9">
					<div class="wrapper_top_shop">
						<div class="row">
							<?php if($hitung<=0):?>
								<div class="container-fluid">
								<h4><span class="text-danger">Mobil Tidak Tersedia</span></h4>
							</div>
								<?php else:?>
							<!-- /womens -->
												...
												<div class="info-product-price">
													<div class="grid_meta">
														<div class="product_price">
															<h4>
																<a href="<?php echo base_url().'kendaraan/'.$tampil->id_vh;?>"><?php echo $tampil->name_vh;?></a>
															</h4>
